...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		RecalculateRating();
		if(curSong.toLowerCase() == "fireworker" && ClientPrefs.shaders){
			addShaderToCamera('camGame', new VCRDistortionEffect(0.1, true, true, true, true));
			addShaderToCamera('camHUD', new VCRDistortionEffect(0.1, true, true, true, true));
		}
		if(curSong.toLowerCase() == "firepower" && ClientPrefs.shaders){
			addShaderToCamera('camGame', new VCRDistortionEffect(0.1, true, true, true, true));
		}
		if(curSong.toLowerCase() == "petrochemical" && ClientPrefs.shaders){
			addShaderToCamera('camGame', new VCRDistortionEffect(0.1, true, true, true, true));
		}
	...
	public function startVideo(name:String, ?finishfunk:Void->Void = null)
		{
			...
			if(foundFile) {
				...
				daVideo.playMP4(filepath, false, null, false, false);
